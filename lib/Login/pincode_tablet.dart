...
class PincodeTablet extends StatefulWidget {
  @override
  _PincodeTabletState createState() => _PincodeTabletState();
}

class _PincodeTabletState extends State<PincodeTablet> {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  normalDialogrequirementTablet(context, 'ลืม PIN code',
                      'ติดต่อระบบหน่วยข้อมูลส่วนกลางเพื่อขอร\nหัสผ่านในการเข้าใช้ระบบอีกครั้ง');
                },
                child: Text(
                  'ลืมรหัส PIN code ?',
                  style: wl22Style,
