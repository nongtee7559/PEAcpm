...
class ConfirmPincodeScreenTablet extends StatefulWidget {
  @override
  _ConfirmPincodeScreenTabletState createState() =>
      _ConfirmPincodeScreenTabletState();
}

class _ConfirmPincodeScreenTabletState
    extends State<ConfirmPincodeScreenTablet> {
  ...
  pinIndexSetup(String text) {
    ...
    if (pinIndex == 6)
      normalDialogrequirementTablet(context, 'เรียบร้อย',
          'ระบบได้ทำการบันทึก PIN code \nของคุณกรุณาเลือกยืนยันเพื่อเข้าสู่หน้าหลัก');
